...
AGENT_ROLES = {
    ...
    "Storyteller": {
        "title": "🌟 Cultural & Special Needs Storyteller Agent",
        "purpose": "Generate tactile audio descriptions for blind learners, KSL sign cues for deaf learners, and African ecological narratives.",
...
class HuntPipelineOrchestrator:
    ...
    def execute_hunt_pipeline(
        ...
        # Step 4: Storyteller Agent - Tactile & Sign Cues Decoration
        audit_trail.append({"agent": "Storyteller", "action": "Decorated response with tactile audio (Blind) and sign cues (Deaf)."})
