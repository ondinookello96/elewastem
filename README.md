...
* **Google Cloud Services Used**:
  ...
  * 🤖 **Google Vertex AI / Gemini 3.7 Flash (High Reasoning Mode with ThinkingConfig) & Google Gemma 2 (Open Weights Edge)**: Orchestrated via the official `google-genai` Python SDK.
